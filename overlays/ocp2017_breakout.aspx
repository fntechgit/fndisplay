<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ocp2017_breakout.aspx.cs" Inherits="fnsignDisplay.overlays.ocp2017_breakout" %>
            ...
            <div class="wrap">
                ...
                <div class="session">
                    <div class="session-time-block">
                        <div class="start-time" id="session_time">
                            <%= current_start_time %>
                        </div>
                        <div class="time">
                            CURRENT SESSION
                    ...
                    <div class="session-speaker-block">
                        <div class="session-title" id="session_title">
                            <%= current_title %>
                        </div>
                        <div class="speaker-name" id="speaker_name">
                            <%= current_speaker %>
                        </div>
                    </div>
                </div>
