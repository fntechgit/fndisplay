<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="barcelona_registration.aspx.cs" Inherits="fnsignDisplay.overlays.barcelona_registration" %>
...
<head id="Head1" runat="server">
    <title></title>
		...
		<style type="text/css">
			...
			.current-time { float: right;margin-top: 20px;color: #eb1f48;font-size: 35px;font-family: "Gotham Narrow A", "Gotham Narrow B";font-style: normal;font-weight: 400;padding-left: 590px; }
...
<body id="thebody">
    ...
    <script type="text/javascript">
        ...
        <script type="text/javascript">
            ...
            setInterval(futureByEvent, 350000);
