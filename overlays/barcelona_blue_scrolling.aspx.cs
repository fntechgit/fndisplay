...
{
    public partial class barcelona_blue_scrolling : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["event_id"] != null)
            {
                ...
                if (t.template_id > 0)
                {
                    ...
                    Session current = _sessions.current(Convert.ToInt32(Session["event_id"]), l.sched_id, _timewarp.display(Convert.ToInt32(Session["event_id"])));
