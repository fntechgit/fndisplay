<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="barcelona_working_groups.aspx.cs" Inherits="fnsignDisplay.overlays.barcelona_working_groups" %>
...
<head id="Head1" runat="server">
    <title></title>
		...
		<style type="text/css">
			...
			.session-type-big {font-family: "Gotham Narrow A", "Gotham Narrow B";font-style: normal;font-weight: 400; margin-top: 240px; font-size: 90px; margin-bottom:0px;color: #ffffff;width: 100%;text-align: center; }
			...
			.time-block { position: absolute;top: 495px; }
			...
			.current-time { float: right;margin-top: 20px;color: #1ca6df;font-size: 35px;font-family: "Gotham Narrow A", "Gotham Narrow B";font-style: normal;font-weight: 400;padding-left: 590px; }
            ...
            .scroll-wrapper-inner { position: absolute;top: 625px; font-family: "Titling Gothic FB Nar Standard";font-style: normal;font-weight: normal;color: #4e4e4e;font-size: 52px;clear: both;overflow: hidden;height: 1220px;width:910px: }
			...
			.ticker div { float: left;margin-top: 0;font-family: "Gotham Narrow A", "Gotham Narrow B";font-style: normal;font-weight: 500;color: #004a7a;font-size: 38px; }
...
<body id="thebody">
    ...
    <div class="wrapper">
        <div class="session-type-big" id="session_title" runat="server">WORKING GROUPS SCHEDULE OF EVENTS</div>
