<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="schedule_of_events.aspx.cs" Inherits="fnsignDisplay.overlays.schedule_of_events" %>
...
<head id="Head1" runat="server">
        ...
        <script src="/js/schedule.js?ver=10.28.16" type="text/javascript"></script>
		...
		<style type="text/css">
            ...
            .time-wrapper span { font-family: "oculus_sansnormal";font-size: 36px;color: #ffffff; }
            .session-wrapper { float: left;width: 70%;padding: 20px 20px 40px 20px;}
            .session-wrapper .session-title { font-family: "oculus_sansnormal";font-size: 36px;color: #ffffff;margin-bottom: 10px;width: 100%; }
            .session-wrapper .session-details { font-family: "oculus_sansbold";font-size: 28px;color: #777779;width: 100%; }
