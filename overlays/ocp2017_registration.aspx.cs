...
{
    public partial class ocp2017_registration : System.Web.UI.Page
    {
                        ...
                        foreach (Session s in sess)
                        {
                            ...
                            if (old != s.start)
                            {
                                ph_sessions.Controls.Add(
                                    new LiteralControl(
                                        "<div class=\"session\"><div class=\"session-time-block\"><div class=\"start-time\">" +
                            ...
                            else
                            {
                                ph_sessions.Controls.Add(
                                    new LiteralControl(
                                        "<div class=\"session\"><div class=\"session-time-block\"><div class=\"start-time\">&nbsp;</div></div><div class=\"session-speaker-block\"><div class=\"session-title\">" +
                                        s.name + "</div><div class=\"speaker-name\">" + s.speakers +
                                        "</div><div class=\"room-name\">" + s.venue +
                                        "</div></div></div><div class=\"space\"></div>"));
                            }
