...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .end-of-day { font-size: 112px; font-family: "Graphik Semibold"; font-weight: bold; position:absolute; text-align: center; left:400px; top: 50%; transform: translateY(-50%); width: 58%; margin: 0 auto; padding-bottom: 10px;}
