...
<head runat="server">
    ...
    <script type="text/javascript">
        setInterval(refreshF8EntryPoint, 5000);
    </script>
    ...
    <style type="text/css">
        ...
        .bod-content { font-size: 42px; position: absolute; width: 1100px; left: 800px; padding:40px;}
        .bod-session {  }
        .bod-session-title {letter-spacing: 1px; font-family: "Graphik"; width:1000px; height:150px;}
        .bod-session-start {font-family: "Trim Mono"; width:180px; float:left;text-align:right;padding-right:30px; height:150px;}
