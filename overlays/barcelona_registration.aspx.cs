...
{
    public partial class barcelona_registration : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["event_id"] != null)
            {
                ...
                if (t.template_id > 0)
                {
                    ...
                    foreach (Session sess in _sessions.future_by_event_by_day(t.event_id, _timewarp.display(t.event_id)))
                    {
