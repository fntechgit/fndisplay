<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="barcelona_blue_scrolling.aspx.cs" Inherits="fnsignDisplay.overlays.barcelona_blue_scrolling" %>
...
<head runat="server">
		...
		<style type="text/css">
			...
			.current-time { float: left;margin-top: 20px;color: #41b5e4;font-size: 45px;font-family: "Gotham Narrow A", "Gotham Narrow B";font-style: normal;font-weight: 400; }
            ...
            .scroll-wrapper-inner { position: absolute;top: 925px; font-family: "Titling Gothic FB Nar Standard";font-style: normal;font-weight: normal;color: #4e4e4e;font-size: 52px;clear: both;overflow: hidden;height: 920px;width:910px: }
...
<body id="thebody">
    ...
    <script type="text/javascript">
        ...
        <script type="text/javascript" src="/js/display.js?ver=B.1"></script>
        <script type="text/javascript" src="/js/group.js?ver=B.1"></script>
        
        
        <script type="text/javascript">
            
            setInterval(refreshData, 5000);
            setInterval(futureBarcelona, 50000);
