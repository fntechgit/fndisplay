...
{
    public partial class ocp2017_breakout : System.Web.UI.Page
    {
            ...
            if (Session["event_id"] != null)
            {
                ...
                if (t.template_id > 0)
                {
                    ...
                    if (sess.Any())
                    {
                        ...
                        {
                            ph_sessions.Controls.Add(new LiteralControl("<div class=\"session\"><div class=\"session-time-block\"><div class=\"start-time\">" + s.start.ToShortTimeString() + "</div></div><div class=\"session-speaker-block\"><div class=\"session-title\">" + s.name + "</div><div class=\"speaker-name\">" + s.speakers + "</div></div></div><div class=\"space\"></div>"));
                        }
                    }
                }
                else
