<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="barcelona.aspx.cs" Inherits="fnsignDisplay.overlays.barcelona" %>
...
<head runat="server">
		...
		<style type="text/css">
			...
			.current-time { float: left;margin-top: 20px;color: #62ba52;font-size: 45px;font-family: "Gotham Narrow A", "Gotham Narrow B";font-style: normal;font-weight: 400; }
