<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="barcelona_red_scrolling.aspx.cs" Inherits="fnsignDisplay.overlays.barcelona_red_scrolling" %>
...
<head runat="server">
		...
		<style type="text/css">
			...
			.ticker div { float: left;margin-top: 0;font-family: "Gotham Narrow A", "Gotham Narrow B";font-style: normal;font-weight: 500;color: #52121f;font-size: 38px; }
...
<body id="thebody">
    ...
    <script type="text/javascript">
        ...
        <script type="text/javascript" src="/js/design.js?ver=B.1"></script>
