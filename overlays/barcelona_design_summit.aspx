<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="barcelona_design_summit.aspx.cs" Inherits="fnsignDisplay.overlays.barcelona_design_summit" %>
...
<body id="thebody">
    ...
    <script type="text/javascript">
        ...
        <script type="text/javascript">
            ...
            setInterval(barcelonaDesignSummit, 50000);
